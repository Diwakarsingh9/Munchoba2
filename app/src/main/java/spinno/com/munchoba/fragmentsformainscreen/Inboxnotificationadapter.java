 ...
 */
public class Inboxnotificationadapter extends BaseAdapter {
    ...
    public Inboxnotificationadapter(Context ctc, String[] strings ) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       final Holder holder;
        ...
        if(convertView== null) {
            convertView = inflater.inflate(R.layout.inboxitemlayout, null);
            holder = new Holder();
        ...
        if(data5[position].equals("title 2")){
            holder.img.setImageResource(R.drawable.read);
        }
        else{
            holder.img.setImageResource(R.drawable.unread);
        }
