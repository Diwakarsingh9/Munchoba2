...
public class Myspotteradapter extends BaseAdapter {
    ...
    public Myspotteradapter(Context context, ArrayList<String> usernames, ArrayList<String> about, ArrayList<String> strings) {
        ctc=context;
        ad=usernames;
        ad2=about;
        ad3=strings;
