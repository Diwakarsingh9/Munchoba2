...
public class Mypagesadapter extends BaseAdapter {
    ...
    public Mypagesadapter(FragmentActivity pagesactivity, ArrayList<String> datedet, ArrayList<String> timedet, ArrayList<String> mealtypedet) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tv4 = (TextView) convertView.findViewById(R.id.pagesnot);
